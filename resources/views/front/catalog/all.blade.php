        ...
        <div class="row mb-5">
            <div class="col-md-12 text-center">
                ...
                <ul class="nav nav-pills justify-content-center mt-5">
                    <li class="nav-item">
                        <a class="nav-link bg-dark text-white" aria-current="page"
                            href="{{route('catalogs.all')}}">All</a>
                    </li>
                    @foreach ($types as $type)
                    <li class="nav-item">
                        <a class="nav-link ms-3 text-dark"
                            href="{{route('catalogs.type',['type' => $type->slug])}}">{{$type->name}}</a>
                    </li>
                    @endforeach
                </ul>
            </div>
            ...
            <div class="col-md-3 mb-5">
                <div class="card border-0 shadow-sm">
                    <a href="{{route('catalogs.show',['coffee' => $coffee->code])}}">
                        <img src="{{asset('storage/assets/images/coffees/'.$coffee->thumbnail)}}" class="card-img-top"
                            alt="Kopiku" style="background-size:cover;background-repeat:no-repeat;background-position:center">
                    </a>
                    <div class="card-body">
