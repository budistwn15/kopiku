...
<div class="container mt-5 mb-5">
    <div class="row">
        <div class="col-md-12 mb-5 text-center">
            <h2 class="fw-bold display-5"><span class="text-secondary-orange">Kategori</span> {{$category->name}}</h2>
            <p>Kopi adalah minuman yang membuat seseorang tertidur saat tidak minum</p>
        </div>
        <div class="col-md-12 mb-3">
            ...
            <div class="card mb-5 border-0 shadow-sm rounded">
                <div class="row">
                    <div class="col-md-4">
                        <img src="{{asset('storage/assets/images/articles/'.$article->thumbnail)}}"
                            class="img-fluid h-100 rounded" alt="...">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            @endforeach
                            <a href="{{route('blogs.show',['article' => $article->slug])}}"
