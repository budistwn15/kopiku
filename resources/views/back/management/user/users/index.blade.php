                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('assets/images/users/'.$user->avatar) ? $user->avatar : '-'}}" class="rounded-circle" width="25">
                                </td>
                                <td>
                                    <div class="btn-toolbar demo-inline-spacing" role="toolbar" aria-label="Toolbar with button groups">
                                        <div class="btn-group" role="group" aria-label="First group">
                                            ...
                                            @csrf
                                            @method('delete')
                                            <button type="submit" class="btn btn-outline-secondary btn-hapus" title="Hapus User" data-name="{{$user->name}}" data-table="user">
